...
export const Footer = () => {
    ...
    return (
        <footer className="w-full shadow-[0_-1px_6px_0_rgba(0,0,0,0.12)] flex flex-col gap-y-5 lg:px-25 pt-7.5 lg:pb-5 pb-2.5">
            <div className="w-full flex lg:flex-row flex-col justify-center lg:justify-between lg:relative lg:items-center mb-5 gap-y-5 lg:gap-auto">
                <div className="flex flex-col items-center lg:items-start gap-y-3">
                    ...
                    {/* hidden for first official launchr */}
                ...
                <div className="gap-2.5 flex justify-center">
                    <Link href="https://www.facebook.com/ChulalongkornUniversity" target="_blank" className="transition-transform duration-200 hover:scale-110">
                        <Facebook size={28} color="black"/>
                    </Link>
                    <Link href="" target="_blank" className="transition-transform duration-200 hover:scale-110">
                        <Linkedin size={28} color="black"/>
                    </Link>
                    <Link href="https://www.instagram.com/cuatclub.chula/" target="_blank" className="transition-transform duration-200 hover:scale-110">
                        <Instagram size={28} color="black"/>
                    </Link>
                    <Link href="https://www.thinc.in.th/" target="_blank" className="transition-transform duration-200 hover:scale-110">
